 ...
 */
b8 renderer_init(renderer_system_state *state_storage, u64 *size_requirement, const window *window) {
 ...
 * @retval FALSE Failure
 */
b8 renderer_command_list_begin(renderer_system_state *_, frame_packet *packet) {
    renderer_backend_interface *interface = (renderer_backend_interface *)state->backend_plugin.interface.state;
 ...
 * @retval FALSE Failure
 */
b8 renderer_command_list_end(renderer_system_state *_, frame_packet *packet) {
    renderer_backend_interface *interface = (renderer_backend_interface *)state->backend_plugin.interface.state;
 ...
 * @param[in,out] packet A pointer to the frame packet to render.
 */
b8 renderer_frame_render(renderer_system_state *_, frame_packet *packet) {
    renderer_backend_interface *interface = (renderer_backend_interface *)state->backend_plugin.interface.state;
